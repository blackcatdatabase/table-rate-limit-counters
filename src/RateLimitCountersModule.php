...
final class RateLimitCountersModule implements ModuleInterface
{
    public function name(): string { return 'table-rate_limit_counters'; }
    public function table(): string { return 'rate_limit_counters'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rlc_subject', 'idx_rlc_window' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rlc_subject', 'idx_rlc_window' ],
            'foreignKeys' => [],
        ];
    }
}
