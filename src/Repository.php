...
{
    private RateLimitCounterRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RateLimitCounterRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto|null
    {
