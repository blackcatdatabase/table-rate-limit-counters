...
namespace BlackCat\Database\Packages\RateLimitCounters;
...
use BlackCat\Database\Packages\RateLimitCounters\Repository\RateLimitCounterRepository as GeneratedRepository;
...
{
  private RateLimitCounterRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RateLimitCounterRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RateLimitCounterRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto|null { return $this->repo->getById($id, $asDto); }
