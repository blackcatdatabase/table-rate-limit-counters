...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rate_limit_counters'; }
    public static function contractView(): string { return 'vw_rate_limit_counters'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'subject_type', 'subject_id', 'name', 'window_start', 'window_size_sec', 'count', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'subject_type', 'subject_id', 'name', 'window_start', 'window_size_sec' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'window_size_sec', 'count' ]; }
