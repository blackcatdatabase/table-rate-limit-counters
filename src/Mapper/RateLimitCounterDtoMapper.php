...
namespace BlackCat\Database\Packages\RateLimitCounters\Mapper;

use BlackCat\Database\Packages\RateLimitCounters\Dto\RateLimitCounterDto;
use BlackCat\Database\Packages\RateLimitCounters\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RateLimitCounterDto:
...
final class RateLimitCounterDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'window_size_sec', 'count' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'window_start', 'updated_at' ];
    /** @var string[] */
     ...
     * @return RateLimitCounterDto
     */
    public static function fromRow(array $row): RateLimitCounterDto
    {
        /** @var RateLimitCounterDto */
        return DtoHydrator::fromRow(
            RateLimitCounterDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RateLimitCounterDto
    {
     ...
     *
     * @param RateLimitCounterDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RateLimitCounterDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RateLimitCounterDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RateLimitCounterDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RateLimitCounterDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RateLimitCounterDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RateLimitCounterDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RateLimitCounterDto>
     */
