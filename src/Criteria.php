...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'subject_type', 'subject_id', 'name', 'window_start', 'window_size_sec', 'count', 'updated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RateLimitCounters\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RateLimitCounters\Definitions::softDeleteColumn();
