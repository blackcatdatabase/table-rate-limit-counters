...
- Pkg folder: [packages\rate-limit-counters](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rate-limit-counters)
...
graph LR
  ...
  rate_limit_counters["rate_limit_counters"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rate-limit-counters -Apply
