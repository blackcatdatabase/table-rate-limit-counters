...
| Pkg folder | [packages\rate-limit-counters](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rate-limit-counters) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rate-limit-counters -Apply
